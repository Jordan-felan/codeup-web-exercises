...
console.log(calculateTip(askTip,askBill));
...
alert("Your tip total is $" + calculateTip(askTip,askBill));
...
var discountPercent = parseFloat(prompt("What is the percentage of the discount? Please use decimal form."));
...
alert("Your total after the discunt is $" + (originalPrice - applyDiscount(originalPrice,discountPercent)));
